...
description: >
  ...
  <example>사용자: "아리스토텔레스의 propeteia와 astheneia 구분을 인용하려는데 출처를 알려줘"</example>
  <example>사용자: "데이비슨이 의지박약을 어떻게 가능하다고 봤는지 핵심 논증을 정리해줘"</example>
...
- **핵심 테제:**
  ...
  - 진정한 앎(epistēmē)은 행위를 인도하므로, 더 나은 것을 알면서 더 나쁜 것을 행하는 일은 **불가능**하다
...
- **권위 있는 한국어 번역본** (역자명 표기는 **길 2011 표제지 순서** 기준):
  ...
  - 같은 역자, 개정판 『니코마코스 윤리학』, **길, 2011** (**학술 인용 표준판** — `humanities/aristotle-primary-citation` 스킬 §6 일치)
...
- **핵심 논증:**
  ...
  - 행위자는 ATC 판단을 하면서도 그에 상응하는 무조건적 판단을 내리지 않을 수 있고, 이때 아크라시아가 발생한다 — 따라서 **논리적으로 가능하지만 비합리적**이다
...
- 결론: 인간 행위를 **이유와 목적**으로 설명하는 목적론적(teleological) 관점 제시, 정신 분할(partitioning) 모델 비판
...
- 의지박약을 "최선 판단(best judgment) 위반"이 아니라 **결심(resolution) 유지의 실패**로 재정의
...
- **(보충) 박장호, "아크라시아와 도덕교육: 도덕적 지식의 의미"**, 『윤리연구』 제72호, **한국윤리학회**, 2009 (KCI 등재 — `education/moral-education-curriculum-link` 스킬 §9-4와 일관)
...
1. **영어권 1차 문헌 위치 확인:** PhilPapers (https://philpapers.org) — 거의 모든 아크라시아 관련 논문이 색인됨
2. **국내 논문 검색:** KCI (https://www.kci.go.kr), DBpia (https://www.dbpia.co.kr) — "아크라시아", "자제력 없음", "의지박약" 검색어 모두 시도
3. **그리스어 원전 인용:** 베커 페이지(예: NE VII.3, 1147a24) + 한국어 번역본 쪽수 병기
4. **SEP 인용 양식 (Chicago):**
   ```
...
- **❌ 실천 추론 결정적 논의 범위를 `1147a24-b5`로만 단정** → 학자마다 `1147a10-b13`, `1146b35-1147b13` 등 다양하게 인용. 사용 판본(Bywater OCT / Irwin / Crisp / 강상진 외)의 실제 행 번호를 직접 확인 후 인용 범위를 명시한다 — fact-checker DISPUTED 결과 반영
