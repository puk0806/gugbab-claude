...
- [hooks/](./docs/hooks/README.md) — 27종 (공통 19 · dev 4 · TypeScript 1 · Memory 3)
...
각 템플릿에 포함된 에이전트·스킬·규칙은 [`examples/`](./examples/) 폴더의 CLAUDE.md에서 확인할 수 있습니다.

| 번호 | 템플릿 | 대상 | 상세 |
|------|--------|------|------|
| 0 | 전체 | 모든 에이전트·스킬·규칙 | — |
| 1 | 유틸 | 비개발자용 (리서치·검증·플래너 등 범용) | [→](./docs/templates/util.md) |
| 2 | react-spa | React SPA + TypeScript | [→](./docs/templates/react-spa.md) |
| 3 | nextjs | Next.js App Router | [→](./docs/templates/nextjs.md) |
| 4 | rust-axum | Rust + Axum 백엔드 | [→](./docs/templates/rust-axum.md) |
| 5 | java-spring-legacy | Java 11 + Spring Boot 2.5 + MyBatis | [→](./docs/templates/java-spring-legacy.md) |
| 6 | java-spring-modern | Java 21 + Spring Boot 3.x | [→](./docs/templates/java-spring-modern.md) |
| 7 | unity-game | Unity 6 LTS 2D 모바일 게임 | [→](./docs/templates/unity-game.md) |
| 8 | academic | 논문·학술·인문학 | [→](./docs/templates/academic.md) |
| 9 | dream-interpretation | 꿈 해몽 앱 도메인 | [→](./docs/templates/dream-interpretation.md) |
...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-06-12 | **README 간소화 + docs/ 연동** — 에이전트·스킬·훅 상세 목록 제거. 프로젝트 구조 카테고리별 클릭 링크 추가. 템플릿별 개별 상세 페이지(9종) 신설. 훅·규칙 개요 페이지 신설. 절대 경로 → 상대 경로 수정 |
