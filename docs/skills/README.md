...
| 카테고리 | 종류 | 설명 |
|----------|------|------|
| [frontend](./frontend/README.md) | 76종 | 프레임워크·상태관리·UI·빌드·테스트·성능·SEO·LLM |
| [backend](./backend/README.md) | 50종 | Rust·Java(레거시/모던)·Python·Claude Code CLI 백엔드 |
| [devops](./devops/README.md) | 10종 | Docker·GitHub Actions·n8n·Vercel Sandbox·SEO 운영 |
| [architecture](./architecture/README.md) | 2종 | DDD·꿈 앱 데이터 모델링 |
