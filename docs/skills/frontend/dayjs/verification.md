...
**비고:** frontend-developer 에이전트로 테스트 예정
...
### 테스트 케이스 3: timezone 플러그인 설정

**입력:**
```
dayjs로 서울 시간 기준 날짜를 파싱하고 뉴욕 시간으로 변환하는 코드 작성해줘
```

**기대 결과:** utc 플러그인 먼저 extend 후 timezone 플러그인 extend, dayjs.tz() API 사용 코드
