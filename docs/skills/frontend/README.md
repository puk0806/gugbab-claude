...
| [code-convention](../../../.claude/skills/frontend/code-convention/SKILL.md) | ESLint 9+ flat config, Biome, Prettier, Husky, lint-staged | [→](./code-convention/verification.md) |

## 테스트

| 스킬 | 설명 | 검증 |
|------|------|------|
| [testing](../../../.claude/skills/frontend/testing/SKILL.md) | Jest/Vitest + React Testing Library, 동작 중심 테스트 전략 | [→](./testing/verification.md) |
| [e2e-testing](../../../.claude/skills/frontend/e2e-testing/SKILL.md) | Playwright E2E — POM, 로케이터, 네트워크 인터셉트, 비주얼 회귀, CI | [→](./e2e-testing/verification.md) |
| [storybook](../../../.claude/skills/frontend/storybook/SKILL.md) | Storybook 8.x — CSF 3.0, args/controls, play function, autodocs | [→](./storybook/verification.md) |
| [storybook-visual-testing](../../../.claude/skills/frontend/storybook-visual-testing/SKILL.md) | Storybook + Playwright 자체 호스팅 시각 회귀 테스트 | [→](./storybook-visual-testing/verification.md) |
...
| [lighthouse-ci-setup](../../../.claude/skills/frontend/lighthouse-ci-setup/SKILL.md) | Lighthouse CI + Core Web Vitals 회귀 감지 설정 | [→](./lighthouse-ci-setup/verification.md) |
| [web-vitals-rum-comparison](../../../.claude/skills/frontend/web-vitals-rum-comparison/SKILL.md) | RUM 실사용자 CWV — Sentry/Datadog 배포 전후 비교 | [→](./web-vitals-rum-comparison/verification.md) |
| [core-web-vitals-optimization](../../../.claude/skills/frontend/core-web-vitals-optimization/SKILL.md) | LCP/INP/CLS 수정 패턴 — Next.js, scheduler.yield, aspect-ratio | [→](./core-web-vitals-optimization/verification.md) |

## SEO·접근성

| 스킬 | 설명 | 검증 |
|------|------|------|
| [seo-nextjs](../../../.claude/skills/frontend/seo-nextjs/SKILL.md) | Next.js 15 App Router SEO — Metadata API, OpenGraph, JSON-LD, sitemap | [→](./seo-nextjs/verification.md) |
| [seo-vite-spa](../../../.claude/skills/frontend/seo-vite-spa/SKILL.md) | Vite/CRA SPA SEO — Googlebot 한계, head 관리, SSG, CRA deprecated | [→](./seo-vite-spa/verification.md) |
...
| [search-console-webmaster](../../../.claude/skills/frontend/search-console-webmaster/SKILL.md) | GSC·Bing·Naver·Yandex·Baidu 콘솔 운영, IndexNow | [→](./search-console-webmaster/verification.md) |
| [mobile-seo-pwa](../../../.claude/skills/frontend/mobile-seo-pwa/SKILL.md) | 모바일 SEO + Web App Manifest — Mobile-First, viewport, PWA | [→](./mobile-seo-pwa/verification.md) |
| [structured-data-validation-api](../../../.claude/skills/frontend/structured-data-validation-api/SKILL.md) | JSON-LD 자동 검증 — schema-dts, CI 통합, GSC URL Inspection API | [→](./structured-data-validation-api/verification.md) |
| [google-indexing-api](../../../.claude/skills/frontend/google-indexing-api/SKILL.md) | Google Indexing API — JobPosting·BroadcastEvent 2타입만 공식 지원 | [→](./google-indexing-api/verification.md) |
...
| [ecommerce-seo](../../../.claude/skills/frontend/ecommerce-seo/SKILL.md) | 이커머스 SEO — Product Schema, 재고 소진, faceted navigation | [→](./ecommerce-seo/verification.md) |
| [local-business-seo](../../../.claude/skills/frontend/local-business-seo/SKILL.md) | 로컬 비즈니스 SEO — NAP, LocalBusiness Schema, 스마트플레이스 | [→](./local-business-seo/verification.md) |
| [seo-monitoring-automation](../../../.claude/skills/frontend/seo-monitoring-automation/SKILL.md) | SEO 모니터링 자동화 — GSC API, IndexNow, GitHub Actions | [→](./seo-monitoring-automation/verification.md) |
...
| [pwa-push-notifications](../../../.claude/skills/frontend/pwa-push-notifications/SKILL.md) | Web Push API + VAPID — iOS Safari 16.4+, 권한 설계 | [→](./pwa-push-notifications/verification.md) |
| [pwa-offline-llm-fallback](../../../.claude/skills/frontend/pwa-offline-llm-fallback/SKILL.md) | PWA 오프라인 LLM 호출 fallback — Background Sync, 재시도 | [→](./pwa-offline-llm-fallback/verification.md) |
| [indexeddb-dexie](../../../.claude/skills/frontend/indexeddb-dexie/SKILL.md) | Dexie 4.4.x IndexedDB — 스키마, 마이그레이션, useLiveQuery | [→](./indexeddb-dexie/verification.md) |

## 꿈 앱 UI (dream-interpretation 템플릿 전용)

| 스킬 | 설명 | 검증 |
|------|------|------|
| [dream-symbol-tagging](../../../.claude/skills/frontend/dream-symbol-tagging/SKILL.md) | 꿈 텍스트 상징 자동 추출 — 룰·LLM·임베딩 하이브리드 | [→](./dream-symbol-tagging/verification.md) |
| [dream-recurrence-detection](../../../.claude/skills/frontend/dream-recurrence-detection/SKILL.md) | 반복 꿈 패턴 감지 — 태그·임베딩·LLM 3종 비교 | [→](./dream-recurrence-detection/verification.md) |
| [emotion-tagging-input](../../../.claude/skills/frontend/emotion-tagging-input/SKILL.md) | 꿈 감정 태깅 UI — Plutchik 8 primary, WAI-ARIA | [→](./emotion-tagging-input/verification.md) |
| [dream-image-generation](../../../.claude/skills/frontend/dream-image-generation/SKILL.md) | 꿈 텍스트 → DALL-E 3/Imagen/Stability AI 이미지 생성 | [→](./dream-image-generation/verification.md) |
| [dream-statistics-visualization](../../../.claude/skills/frontend/dream-statistics-visualization/SKILL.md) | 꿈 통계 시각화 — Recharts, 워드클라우드, 히트맵 | [→](./dream-statistics-visualization/verification.md) |
| [dream-app-onboarding](../../../.claude/skills/frontend/dream-app-onboarding/SKILL.md) | 꿈 앱 온보딩 5단계 — 권한 priming, 안전 자원 안내 | [→](./dream-app-onboarding/verification.md) |
